...
# colors for plotting diffrent curves
colors = px.colors.qualitative.Plotly

#############################
# some utility dictionaries #
#############################
...
@app.callback([Output("MB-plot", "figure"),
